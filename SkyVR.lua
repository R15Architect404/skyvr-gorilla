...
local CWC = function()
	if (workspace["Left Hand"].Position - workspace.a.Position).Magnitude < (workspace["Right hand"].Position - workspace.a.Position).Magnitude then
		return "l",(workspace["Left Hand"].Position - workspace.a.Position).Magnitude
	elseif (workspace["Left Hand"].Position - workspace.a.Position).Magnitude > (workspace["Right hand"].Position - workspace.a.Position).Magnitude then
		return "r",(workspace["Right hand"].Position - workspace.a.Position).Magnitude
